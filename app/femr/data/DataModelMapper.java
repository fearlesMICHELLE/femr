...
public class DataModelMapper implements IDataModelMapper{
     ...
     */
    @Override
    public IPatient createPatient(int userID, String firstName, String lastName, Date birthday, String isApproximateAge, String sex, String address, String city, Integer photoID) {
        ...
        patient.setIsApproximateAge(isApproximateAge);
        patient.setSex(sex);
